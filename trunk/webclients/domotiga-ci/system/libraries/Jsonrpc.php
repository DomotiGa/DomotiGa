...
class JSON_RPC_Request extends JSON_RPC_Message {
    ...
    var $accept= 'application/json,application/javascript,text/javascript,text/xml';
	...
	if($this->request_method == 'POST') {
	    ...
	    $data = xmlrpc_encode_request($this->request_method,$params);
