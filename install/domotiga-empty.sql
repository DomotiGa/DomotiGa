...
ol 0xa1b2'),(703,'LaCrosse Device','LaCrosse RFLink Device','LaCrosse','lacrosse 0xa1b2'),(704,'NewKAKU Device','NewKAKU RFLink Device','NewKAKU','00cac142 03'),(705,'UPM Device','UPM RFLink Device','UPM','c142'),(706,'UniPi','UniPi Device','UniPi','relay 1 or ao 1');
...
CREATE TABLE `settings_jsonrpc` (
  ...
  `debug` tinyint(1) NOT NULL DEFAULT '0',
  `sslenabled` tinyint(1) NOT NULL DEFAULT '0',
  `sslcertificate` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
