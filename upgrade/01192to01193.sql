...
ALTER TABLE `settings_rfxcomtx` DROP COLUMN `debug`;
ALTER TABLE `settings_rfxcomtx` ADD COLUMN `rfxmitter` tinyint(1) DEFAULT NULL AFTER acaddress2;
ALTER TABLE `settings_rfxcomtx` ADD COLUMN `debug` tinyint(1) DEFAULT NULL AFTER rfxmitter;
...
INSERT INTO `settings_owfs` VALUES (0,0,300,'/var/1-wire',1,0),(1,-1,300,'/tmp/1wire',-1,0);
...
-- Dump completed on 2010-12-29  9:37:04
