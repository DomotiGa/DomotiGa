...
ALTER TABLE `actions` MODIFY `param1` text;
ALTER TABLE `actions` MODIFY `param2` text;
ALTER TABLE `actions` MODIFY `param3` text;
ALTER TABLE `actions` MODIFY `param4` text;
ALTER TABLE `actions` MODIFY `param5` text;
UNLOCK TABLES;
...
ALTER TABLE `graphs` ADD COLUMN `groups` varchar(128) default NULL AFTER grid_type;
...
-- Dump completed on 2010-09-23 19:24:47
