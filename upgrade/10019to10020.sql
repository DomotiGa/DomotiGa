...
ALTER TABLE device_valuestypes CHANGE COLUMN `type` `type` VARCHAR(16) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE device_valuestypes CHANGE COLUMN `units` `units` VARCHAR(16) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE device_valuestypes CHANGE COLUMN `description` `description` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
