...
ALTER TABLE settings_broadcastudp DEFAULT CHARACTER SET utf8;
ALTER TABLE settings_broadcastudp CHANGE COLUMN `targetip` `targetip` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
...
ALTER TABLE settings_conrad8relay DEFAULT CHARACTER SET utf8;
ALTER TABLE settings_conrad8relay CHANGE COLUMN `tcphost` `tcphost` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE settings_conrad8relay CHANGE COLUMN `type` `type` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE settings_conrad8relay CHANGE COLUMN `serialport` `serialport` VARCHAR(128) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE settings_conrad8relay CHANGE COLUMN `baudrate` `baudrate` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
...
ALTER TABLE settings_ipx800 DEFAULT CHARACTER SET utf8;
ALTER TABLE settings_ipx800 CHANGE COLUMN `tcphost` `tcphost` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE settings_ipx800 CHANGE COLUMN `username` `username` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
ALTER TABLE settings_ipx800 CHANGE COLUMN `password` `password` VARCHAR(32) CHARACTER SET 'utf8' NULL DEFAULT NULL;
