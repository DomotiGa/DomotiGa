...
ALTER TABLE graph_data CHANGE COLUMN `name` `name` VARCHAR(32) CHARACTER SET 'utf8' NOT NULL;
...
ALTER TABLE graphs CHANGE COLUMN `comments` `comments` VARCHAR(32) CHARACTER SET 'utf8' NOT NULL DEFAULT NULL;
...
ALTER TABLE scenes CHANGE COLUMN `description` `description` TEXT CHARACTER SET 'utf8' NULL DEFAULT NULL;
...
ALTER TABLE tv_channels CHANGE COLUMN `CategoryName` `CategoryName` VARCHAR(50) CHARACTER SET 'utf8' NOT NULL;
...
ALTER TABLE version CHANGE COLUMN `name` `name` VARCHAR(16) CHARACTER SET 'utf8' NULL DEFAULT NULL;
