...
UPDATE settings_astro SET `dst`='0' WHERE `dst` IS NULL;
...
UPDATE settings_callerid SET `autocreatecontacts`='0' WHERE `autocreatecontacts` IS NULL;
...
UPDATE settings_ctx35 SET `globalx10`='0' WHERE `globalx10` IS NULL;
...
UPDATE settings_email SET `sslenabled`='0' WHERE `sslenabled` IS NULL;
...
UPDATE settings_mochad SET `globalX10`='0' WHERE `globalX10` IS NULL;
...
UPDATE settings_mqtt SET `retain`='0' WHERE `retain` IS NULL;
...
UPDATE settings_mysensors SET `relayenabled`='0' WHERE `relayenabled` IS NULL;
