...
ALTER TABLE `settings_heyu` ADD COLUMN `globalx10` tinyint(1) DEFAULT NULL AFTER monitor;

--
-- Table structure for table `settings_ctx35`
--

ALTER TABLE `settings_ctx35` ADD COLUMN `globalx10` tinyint(1) DEFAULT NULL AFTER polltime;

--
-- Table structure for table `settings_rfxcomrx`
--

ALTER TABLE `settings_rfxcomrx` ADD COLUMN `globalx10` tinyint(1) DEFAULT NULL AFTER relayport;
...
-- Dump completed on 2010-12-05 12:07:37
