...
INSERT INTO `markers` VALUES (1,'Work','Rozenburg',51.102371,4.142234),(2,'Home','Domotigastraat 1, Dordrecht',51.18711,4.38526);
...
-- Alter table `devices`
--
ALTER TABLE `devices` MODIFY `value` text;
ALTER TABLE `devices` MODIFY `value2` text;
ALTER TABLE `devices` MODIFY `value3` text;
ALTER TABLE `devices` MODIFY `value4` text;
...
-- Dump completed on 2010-11-14 16:00:07
