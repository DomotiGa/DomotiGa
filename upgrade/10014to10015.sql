...
--
UPDATE `actions` set `type`='0' WHERE `type` IS NULL;
UPDATE events set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE events set `log`='0' WHERE `log` IS NULL;
UPDATE events set `trigger1`='0' WHERE `trigger1` IS NULL;
UPDATE events set `condition1`='0' WHERE `condition1` IS NULL;
UPDATE events set `condition2`='0' WHERE `condition2` IS NULL;
UPDATE events set `rerunenabled`='0' WHERE `rerunenabled` IS NULL;
UPDATE events set `rerunvalue`='0' WHERE `rerunvalue` IS NULL;
UPDATE events set `category`='0' WHERE `category` IS NULL;
UPDATE device_values set `log`='0' WHERE `log` IS NULL;
UPDATE device_values set `logdisplay`='0' WHERE `logdisplay` IS NULL;
UPDATE device_values set `logspeak`='0' WHERE `logspeak` IS NULL;
UPDATE device_values set `rrd`='0' WHERE `rrd` IS NULL;
UPDATE device_values set `graph`='0' WHERE `graph` IS NULL;
UPDATE devices set `instance`='1' WHERE `instance` IS NULL;
UPDATE devices set `module`='0' WHERE `module` IS NULL;
UPDATE devices set `location`='0' WHERE `location` IS NULL;
UPDATE devices set `interface`='0' WHERE `interface` IS NULL;
UPDATE devices set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE devices set `hide`='0' WHERE `hide` IS NULL;
UPDATE devices set `tampered`='0' WHERE `tampered` IS NULL;
UPDATE devices set `switchable`='0' WHERE `switchable` IS NULL;
UPDATE devices set `dimable`='0' WHERE `dimable` IS NULL;
UPDATE devices set `extcode`='0' WHERE `extcode` IS NULL;
UPDATE devices set `x`='0' WHERE `x` IS NULL;
UPDATE devices set `y`='0' WHERE `y` IS NULL;
UPDATE devices set `floorplan`='0' WHERE `floorplan` IS NULL;
UPDATE devices set `repeatstate`='0' WHERE `repeatstate` IS NULL;
UPDATE devices set `repeatperiod`='0' WHERE `repeatperiod` IS NULL;
UPDATE devices set `reset`='0' WHERE `reset` IS NULL;
UPDATE devices set `resetperiod`='0' WHERE `resetperiod` IS NULL;
UPDATE devices set `poll`='0' WHERE `poll` IS NULL;
UPDATE devices_camera set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE graphs set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE menu set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE newsfeeds set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE scenes set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE trafficfeeds set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE weatherfeeds set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE contacts set `holidaycard`='0' WHERE `holidaycard` IS NULL;
UPDATE contacts set `type`='0' WHERE `type` IS NULL;
UPDATE settings_arduino set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_arduino set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_asterisk set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_asterisk set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_astro set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_bluetooth set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_bluetooth set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_bwiredmap set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_bwiredmap set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_callerid set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_callerid set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ctx35 set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ctx35 set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_cul set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_cul set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_currentcost set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_currentcost set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_denon set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_denon set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_digitemp set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_digitemp set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_dmxplayer set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_dmxplayer set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_domotica set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_domotica set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_dsc set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_dsc set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_dsc set `type`='0' WHERE `type` IS NULL;
UPDATE settings_eib set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_eib set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_elvmax set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_elvmax set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_email set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_email set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ezcontrol set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ezcontrol set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_fritzbox set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_fritzbox set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_genericio set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_genericio set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_gmail set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_gmail set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_gps set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_gps set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_hddtemp set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_hddtemp set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_homematic set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_homematic set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_iport set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_iport set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_irman set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_irman set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_irtrans set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_irtrans set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_iviewer set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_iviewer set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_jeelabs set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_jeelabs set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_jsonrpc set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_jsonrpc set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_k8055 set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_k8055 set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_kmtronicudp set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_kmtronicudp set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ledmatrix set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ledmatrix set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_lgtv set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_lgtv set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_lirc set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_lirc set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_main set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_meteohub set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_meteohub set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_mochad set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_mochad set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_mqtt set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_mqtt set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ncid set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ncid set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_nma set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_nma set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_omniksol set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_omniksol set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_onkyo set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_onkyo set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_opentherm set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_opentherm set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_openzwave set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_openzwave set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_owfs set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_owfs set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_oww set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_oww set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_p2000 set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_p2000 set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_pachube set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_pachube set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ping set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ping set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_pioneer set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_pioneer set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_plcbus set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_plcbus set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_plugwise set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_plugwise set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_prowl set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_prowl set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_pushover set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_pushover set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_pvoutput set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_pvoutput set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_pwrctrl set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_pwrctrl set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_razberry set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_razberry set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_rfxcomrx set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_rfxcomrx set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_rfxcomtrx set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_rfxcomtrx set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_rfxcomtx set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_rfxcomtx set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_rfxcomxpl set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_rfxcomxpl set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_rrdtool set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_rrdtool set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_serverstats set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_serverstats set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_sharptv set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_sharptv set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_shell set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_shell set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_smartmeter set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_smartmeter set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_smartvisuserver set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_smartvisuserver set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_sms set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_sms set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_sound set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_sound set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_squeezeserver set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_squeezeserver set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_telnetserver set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_telnetserver set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_temp08 set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_temp08 set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_temperaturnu set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_temperaturnu set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_thermostat set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_thermostat set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_tvguide set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_tvguide set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_twitter set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_twitter set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_ups set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_ups set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_videoserver set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_videoserver set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_visca set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_visca set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_visonic set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_visonic set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_voicetext set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_voicetext set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_weatherbug set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_weatherbug set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_weatherug set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_weatherug set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_weeder set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_weeder set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_x10cmd set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_x10cmd set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_xbmcxpl set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_xbmcxpl set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_xmlrpc set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_xmlrpc set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_xpl set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_xpl set `debug`='0' WHERE `debug` IS NULL;
UPDATE settings_youless set `enabled`='0' WHERE `enabled` IS NULL;
UPDATE settings_youless set `debug`='0' WHERE `debug` IS NULL;
